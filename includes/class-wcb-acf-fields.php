        ...
        if( function_exists('acf_add_local_field_group') ) {
            acf_add_local_field_group(array(
                ...
                'fields' => array(
                    ...
                    array(
                        'key' => 'field_6gs34hd78632c',
                        'label' => 'Children\'s field caption',
                        'name' => 'childrens_field_caption',
                        'type' => 'text',
                        'instructions' => '',
                        'required' => 0,
                        'conditional_logic' => 0,
                    ...
                    array(
                        'key' => 'field_5caa684db47c1',
                        'label' => 'Sell activity by vehicle',
                        'name' => 'is_vehicle',
                        'type' => 'true_false',
                        'instructions' => '',
                        'required' => 0,
                        ...
                        'message' => 'Check this box if this activity should be sold by vehicles and not by audits and children.',
                        'default_value' => 0,
                        'ui' => 1,
                        'ui_on_text' => '',
                        'ui_off_text' => '',
            ...
            acf_add_local_field_group(array(
                'key' => 'group_5cb959de2d01f',
                'title' => 'Souvenirs',
                'fields' => array(
                    array(
                        'key' => 'field_5cb96fc244368',
                        'label' => 'Active?',
                        'name' => 'souvenir_active',
                        'type' => 'true_false',
                        'instructions' => '',
                        'required' => 0,
                        'conditional_logic' => 0,
                    ...
                    array(
                        'key' => 'field_5cb95d39dd598',
                        'label' => 'Valid with other discounts?',
                        'name' => 'souvenir_valid_with_other_discounts',
                        'type' => 'true_false',
                        'instructions' => '',
                        'required' => 0,
                        'conditional_logic' => array(
                    ...
                    array(
                        'key' => 'field_5cb95c5fdd596',
                        'label' => 'Increase price?',
                        'name' => 'souvenir_increase_price',
                        'type' => 'true_false',
                        'instructions' => '',
                        'required' => 0,
                        'conditional_logic' => array(
                    ...
                    array(
                        'key' => 'field_5cb95f0add59b',
                        'label' => 'Days of anticipation to apply this souvenir',
                        'name' => 'days_of_anticipation_to_apply_this_souvenir',
                        'type' => 'number',
                        'instructions' => '',
                        'required' => 0,
                        'conditional_logic' => array(
                    ...
                    array(
                        ...
                        'max' => 0,
                        'layout' => 'block',
                        'button_label' => 'Add gift',
                        'sub_fields' => array(
                            array(
                                'key' => 'field_5cb95e9edd59a',
                                'label' => 'Name',
                                'name' => 'name',
                                'type' => 'text',
                                'instructions' => '',
